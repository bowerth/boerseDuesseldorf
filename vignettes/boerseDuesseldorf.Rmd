...
## export_file_history <- "../inst/extdata/history-sample.rda"
## for pkgdown
...
export_file_history <-
  system.file("extdata", "history.rda", package = "boerseDuesseldorf")
```
...
```{r show_history, eval=TRUE, results="as.is"}
load(file = export_file_history)
knitr::kable(history_df_sorted[1:10, ])
```
